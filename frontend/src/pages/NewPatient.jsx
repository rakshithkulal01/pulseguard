  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const message = getErrorMessage(
        err,
        "Unable to create the patient profile.",
      );
      setError(message);
        ...
        <div className="small-brand">
          <div className="small-logo">
            ...
            >
              ...
              <path
                d="M6 21H12L15 16L19 25L23 14L27 21H34"
                stroke="#1769ff"
                strokeWidth="2"
                strokeLinecap="round"
          ...
          <div>
            <div className="small-brand-name">PulseGuard</div>
            <div className="small-brand-subtitle">AI HEALTH PLATFORM</div>
          </div>
        </div>
        <button
      ...
      <main className="new-patient-content">
        <div className="page-title">
          ...
          <div>
            ...
            <p>Create a secure patient profile to begin ECG monitoring.</p>
          </div>
        </div>
          ...
          <form className="form-body" onSubmit={handleSubmit} noValidate>
            ...
            <div className="form-row">
              ...
              <Select
                ...
                onChange={handleChange}
                options={Object.keys(BLOOD_GROUPS)}
            ...
            <div className="security-message">
              ...
              <div>
                ...
                <p>
                  Patient data is sent through the authenticated PulseGuard API.
                </p>
              </div>
            </div>
            <div className="form-footer">
              ...
              <Button type="submit" className="create-button" loading={loading}>

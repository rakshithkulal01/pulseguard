...
export const DashboardWelcome = ({ search, onSearch }) => (
  <section className="welcome-section">
    <div className="welcome-content"><h2>Welcome 👋</h2></div>
    <div className="search-box"><span className="search-icon">⌕</span><input type="text" placeholder="Search patients..." value={search} onChange={(e) => onSearch(e.target.value)} /></div>
  </section>
);
